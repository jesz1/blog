<div>
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-form-section submit="addTeamMember">
                <x-slot name="title">
                    {{ __('Agregar a un miembro') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Aqui puedes agregar un colaborador para tu curso') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Coloca la informacion del colaborador:') }}
                        </div>
                    </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('Agregar miembro', $team))
        <x-jet-section-border />
        ...
        <div class="mt-10 sm:mt-0">
            <x-jet-action-section>
                <x-slot name="title">
                    {{ __('Invitacion pendiente de curso') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Alguien quiere que te unas  su curso') }}
                </x-slot>
